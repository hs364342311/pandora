...
docker run -d -it --name $containerName -p 6100:6100 --privileged=true -e USER_CONFIG_DIR="/data" -e PANDORA_OPEN_AUTHLOGIN=false -e PANDORA_SERVER="0.0.0.0:6100" -v /data/pandora_data:/data $imageName
